...
export default function TripPlannerForm({ onSubmit, loading }) {
    ...
    <div className="trip-form-card">
      <div className="form-card-header">
        <div className="form-title-group">
          ...
          <p className="form-subtitle">Enter route waypoints to calculate optimal trajectory & HOS stops</p>
        </div>
      ...
      <form onSubmit={handleSubmit} className="planner-form-grid">
        ...
        <div className="form-field-group">
          <label className="field-label">
            ...
            <span>Current Location (Start)</span>
          </label>
        ...
        <div className="form-field-group">
          <label className="field-label">
            ...
            <span>Current Cycle Hours Used</span>
          </label>
          <div className="input-wrapper">
            <input
              type="number"
          ...
          <button type="submit" className="plan-btn" disabled={loading}>
            {loading ? (
              <span className="btn-loading-state">
                ...
                <span>Calculating Route & Geocodes...</span>
              </span>
            ) : (
